<html>
<head>
	<title>Uncommon elements in two arrays | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="The logic in our program  will compare every element of both the arrays and will print the list of elements which are not common in both the arrays.">
        <meta name="keywords" content="Java, Algorithms, Uncommon Elements, Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='total-occurrences.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='generate-random-string.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to identify uncommon elements between two arrays.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>In this demo, we are passing two integer arrays as argument to the function. Our logic will compare every element of both the arrays and will print
				the list of elements which are not common in both the arrays.</p>
...
/**
 * The UncommonElements program will find the uncommon elements in two arrays
...
public class UncommonElements {
	...
	public void findUncommon(int[] a, int[] b) {
	...
	public static void main(String[] args) {
		UncommonElements object = new UncommonElements();

		int array1[] = { 3, 2, 6, 1, 11, 25 };
		int array2[] = { 4, 2, 5, 13, 11 };

		object.findUncommon(array1, array2);
	}
}
</code>
</pre>
...
<code>
Uncommon Elements : [3, 6, 1, 25, 4, 5, 13]
</code>
</pre>
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('uncommon-elements', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('uncommon-elements', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			//change page_id for other pages
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'uncommon-elements' ";
