<html>
<head>
	<title>Swap Two Numbers - Beginner Level Java Algorithm | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="This demo shows two ways of how to swap two numbers, i.e. Swap two numbers using temporary variable and swap two numbers without using a temporary variable.">
        <meta name="keywords" content="Java, Algorithms, Swap Two Numbers, Swap, Third, Temporary, Variable, Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='check-palindrome.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='calculate-factorial.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to swap two numbers.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				Swapping two numbers is quite a simple task in Java.
				We are going to show you two different ways to swap two numbers in Java.
				</p>
				<ol>
				<li><a href="#swap-with-temp">Swap using temporary or third variable.</a></li>
				<li><a href="#swap-without-temp">Swap without using temporary or third variable.</a></li>
				</ol>
				<hr>
				<p id="swap-with-temp"><h4 id="title">1. Program to  swap two numbers using a temporary or third variable.</h4></p>
				<hr>
<pre class="language-java line-numbers" >
<code>package com.algorithms.beginner;

/**
 * The SimpleSwap program implements an application that make use of a temporary
 * variable to swap two numbers and print the result before swapping and after
 * swapping the numbers in the console.
 *
 * @author Pawan
 * @version 1.0
 * @since 2017-04-28
...
public class SimpleSwap {
	...
	public static void main(String[] args) {
		SimpleSwap swapObj = new SimpleSwap();
		swapObj.swap(4, 13);
	}
}
</code>
...
<hr>
<p id="swap-without-temp"><h4 id="title">2. Program to  swap two numbers without using a temporary or third variable.</h4></p>
<hr>
...
/**
 * The SwapNumbers program implements an logic that swap two numbers without
 * using a temporary or third variable and print the result before swapping and
 * after swapping the numbers in the console.
 *
 * @author Pawan
 * @version 1.0
 * @since 2017-04-28
