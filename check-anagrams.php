<html>
<head>
	<title>Check Anagrams - Algorithms in Java | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="Two words or phrases are said to be anagrams if one word or phrase is formed by rearranging the letters of the second word or phrase. e.g, silent and listen">
        <meta name="keywords" content="Java, Algorithms, anagrams, intermediate, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='find-lcm-and-gcd.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='check-pangrams.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to check if two strings are anagrams or not.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>What are Anagrams? <br>
				<b>Anagrams :</b> Two words or phrases are said to be anagrams if one word or phrase is formed by rearranging the letters of the second word or phrase. For example, <mark>silent</mark> and <mark>listen</mark> are anagrams.<br>
			    The program to check if two strings are anagrams or not involves the steps listed below:<br>
				<ol>
				<li>Remove all the white spaces from both the input strings (str1 and str2) and store them in new String variables say temp1 and temp2.</li>
				<li>Now compare the lengths of both temp1 and temp2. If they are not equal, we can conclude that they are not anagrams.</li>
				<li>Convert temp1 and temp2 in either lower case or upper case. In our demo, we have converted temp1 and temp2 to upper case.</li>
				<li>After changing temp1 and temp2 to uppercase, convert these strings to array of char type using <b>toCharArray()</b> function of String class in Java.</li>
				<li>Sort the elements of these two arrays using <b>Arrays.sort(char [ ] array)</b> and check if they are equal or not using <b>equals()</b> method.</li>
				<li>If the equals() method returns true, this means both the strings are anagrams. Otherwise, they are not anagrams.</li>
				</ol>	
                <p>See the below implementation	of the logic explained above.		
				</p>
...
/**
 * The Anagrams program checks if two strings are anagrams or not.
 *
 * @author Pawan 
 * @version 1.0
 * @since 2017-05-23
...
public class Anagrams {
	...
	public void checkAnagrams(String str1, String str2) {
		...
		// remove white spaces from both str1 and str2
		String temp1 = str1.replace("\\s", "");
		String temp2 = str2.replace("\\s", "");
		...
		if (temp1.length() != temp2.length()) {
			...
			char[] temp1Array = temp1.toUpperCase().toCharArray();
			char[] temp2Array = temp2.toUpperCase().toCharArray();

			Arrays.sort(temp1Array);
			Arrays.sort(temp2Array);

			isAnagram = Arrays.equals(temp1Array, temp2Array);
		}
	...
	public static void main(String[] args) {
		...
		anagrams.checkAnagrams("allergy", "gallery");
		anagrams.checkAnagrams("debit card", "bad credit");
		anagrams.checkAnagrams("breaks", "breads");
	}
}
</code>
</pre>
...
<code>
allergy and gallery are anagrams
debit card and bad credit are anagrams
breaks and breads are not anagrams
</code>
</pre>
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('check-anagrams', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('check-anagrams', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'check-anagrams' ";
