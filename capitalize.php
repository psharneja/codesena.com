<html>
<head>
	<title>Capitalize first letter of every word in sentence | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="To write a program to capitalize the first letter of every word in a sentence using Java, you need to have an understanding of the few functions of String class.">
        <meta name="keywords" content="Java, Algorithms, Capitalize, Intermediate, String Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='largest-smallest.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='floyds-triangle.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to capitalize first letter of every word in a sentence.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				To write this program, you need to have understanding of the few functions of <b>String</b> class in Java which are listed as below :</p>
				<ul>
					<li><b>split(String regex) -</b> This function returns a String array by splitting the input string based on the regular expression passed as a parameter to it.</li>
					<li><b>substring(int startIndex, int endIndex) -</b> As clear from its name, this function returns a sub-string from the given input string based on the provided start index and end index. Please note that start index is inclusive whereas the end index is exclusive.</li>
					<li><b>toUpperCase() -</b> This function converts all the characters in a string to upper case.</li>	
					<li><b>length() -</b> This function returns the length of a string, i.e. the total number of characters in a string.</li>	
					<li><b>concat() -</b> This function joins two strings.</li>	
				</ul>
				<p>Now see how we used above mentioned functions in order to achieve desired results.</p>
<pre class="language-java line-numbers" >
<code>package com.algorithms.beginner;

/**
 * The Capitalize program will capitalize the first letter of every word in the
 * given sentence and prints the result in console.
 *
 * @author Pawan
 * @version 1.1
 * @since 2017-05-04
...
public class Capitalize {
	...
	public void capitalizeFirstLetter(String str) {
		...
		for (String string : split) {
			capitalized = capitalized + string.substring(0, 1).toUpperCase().concat(string.substring(1, string.length())) + " ";
		}
		System.out.println("After capitalizing : " + capitalized);
	}

	public static void main(String[] args) {
		Capitalize object = new Capitalize();
		object.capitalizeFirstLetter("i am a java developer");
	}
}
</code>
</pre>
...
<code>
Before capitalizing : i am a java developer
After capitalizing : I Am A Java Developer 
</code>
</pre>
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('capitalize', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('capitalize', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			//change page_id for other pages
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'capitalize' ";
