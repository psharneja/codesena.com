<html>
<head>
	<title>Remove Duplicate Elements - Algorithms in Java | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="To remove duplicate elements from an array, we are adding elements of the input array to the Set because  the Set interface in Java stores unique elements only.">
        <meta name="keywords" content="Java, Algorithms, remove duplicates, duplicate elements, Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='calculate-ncr-npr.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='diamond-patterns.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to remove duplicate elements from an array.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>The logic of this program includes two steps:<br>
				In the first step, we are adding elements of the input array to the Set collection. The <b>Set </b>interface in Java contains unique elements only. So, when we are
				adding elements of the array to the Set, it will store only unique values.<br>
				In the second step, we are again converting Set to array and display it.<br>
...
/**
 * The RemoveDuplicate program will remove the duplicate elements from an array
...
public class RemoveDuplicate {
	...
	private void removeDuplicate(int[] array) {

		System.out.println("--- Original Array with duplicate elements ---");

		for (int elements : array) {
			System.out.print(elements + " "); // print array having duplicate elements
		}
		System.out.println();

		Set&lt;Integer&gt; set = new HashSet&lt;Integer&gt;();
		for (int items : array) {
			set.add(items); // add elements of array to Set.
		}

		Object[] newArray = set.toArray(); // convert Set to Array

		System.out.println("--- Array without any duplicate element ---");
		for (Object elements : newArray) {
			System.out.print(elements + " "); // print array without duplicate elements
		}
	}
	...
	public static void main(String[] args) {
		...
		int array[] = { 1, 2, 2, 4, 5, 6, 7, 7, 13, 13 };
...
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('remove-duplicate', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('remove-duplicate', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'remove-duplicate' ";
