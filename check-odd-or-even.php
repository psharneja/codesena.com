<html>
<head>
	<title>Check Odd or Even - Beginner Level Java Algorithms | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="How to check whether a number is odd or even in Java? In our demo, we are going to write a Java program that checks if the given input integer is odd or even.">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='merge-sort-algorithm.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='check-prime-number.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to check whether the given integer is odd or even.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				This program checks whether the integer value we are passing to the
				function is even or odd.</p>
				<p>Firstly, let's understand what are even and odd numbers.</p>
				<p><b>Even Numbers :</b> A number is said to be even if it is completely divisible by 2. For example, 0, 2, 4, 6, 8, 10 and so on.<br>
				<b>Odd Numbers :</b> A number is said to be odd if it is not completely divisible by 2. For example, 1, 3, 5, 7, 9 and so on.
				</p>
				<p>
				In below program, we are using <b>'%'</b> operator, i.e. <b>Modulus</b> or <b>Remainder</b> operator which simply returns the remainder of two numbers.
				We are dividing the input integer by 2. If the result is zero, it means the input is an Even number or else it is an Odd number.
				</p>
<pre class="language-java line-numbers" >
<code>package com.algorithms.beginner;

/**
 * The OddEven program implements an application that checks whether the number
 * we are passing to the function is even or odd and display the result in console.
 *
 * @author Pawan
 * @version 1.0
 * @since 2017-04-20
...
public class OddEven {
	...
	// method to check whether the input is even or odd
	...
	public static void main(String[] args) {
		...
		obj.isEvenOrOdd(12); // prints 12 is an even number.
		obj.isEvenOrOdd(13); // prints 13 is an odd number.
	}
}
</code>
</pre>
...
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('even-odd', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('even-odd', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'even-odd' ";
		...
		<!-- display comment section with replies - end -->
				...
				<div id="navigation" class = "row-fluid">
					<div id="previous" class="col-md-2 col-lg-2 pull-left" style="cursor:not-allowed">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
					</div>
					<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='check-prime-number.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
