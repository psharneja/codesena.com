<html>
<head>
	<title>No. of possibilities and combinations (nCr & nPr) | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="The program to calculate no. of possibilities and combinations will ask user to enter the value for 'n' and 'r', calculate the nPr and nCr and print the result.">
        <meta name="keywords" content="Java, Algorithms, possibilities and combinations, Program, npr, ncr, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='generate-random-string.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='remove-duplicate.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to calculate nCr and nPr.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				Before going into coding section, let's understand these mathematical terms <b>nPr</b> and <b>nCr</b>.</p>
				<ul>
				<li><b>nPr -</b> By definition, nPr is the no. of possibilities of choosing an ordered set of 'r' elements from a total of 'n' elements'. 
				<br> Mathematical formula for nPr is, <mark>nPr(n,r) = n!/(n-r)! </mark></li>
				<li><b>nCr -</b>  By definition, nCr is the no. of different, unordered combinations of 'r' elements from a set of 'n' elements.
				<br> Mathematical formula for nCr is, <mark>nCr(n,r) = n!/((n-r)! * r!) </mark></li></li>
				</ul>				
				<p>As we can see in the above formulas, the calculations involve finding factorial of a number. In our earlier tutorial, we have already covered how to calculate factorial 
				of a number. If you are not aware about calculating factorial of a number, please go through this link - <a href="calculate-factorial.php">Find Factorial</a>.<br>
				The below code will ask user to enter the value for 'n' and 'r', calculate the nPr and nCr and print the result in console.</p>
...
/**
 * The NPRandNCR program will calculate the nPr and nCr and print the result in
 * console.
 *
 * @author Pawan
 * @version 1.0
...
public class NPRandNCR {
	...
	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in); // read the input from console
		...
		scanner.close(); //close resource after using it

		int nPr = 0, nCr = 0;

		// using formula nPr = n!/(n-r)!
		nPr = calculateFactorial(n) / calculateFactorial(n - r); 

		// using formula nCr = n!/((n-r)! * r!)
		nCr = calculateFactorial(n) / (calculateFactorial(n - r) * calculateFactorial(r)); 
		
		System.out.println("nPr = " + nPr + " and nCr = " + nCr);
	}
}
</code>
</pre>
...
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('ncr-npr', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('ncr-npr', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			//change page_id for other pages
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'ncr-npr' ";
