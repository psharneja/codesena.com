<html>
<head>
	<title>Forum  - Discussion Corner for our visitors | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="Codesena provides a forum where you can get answers to your queries. Also, on this forum you can have discussion with other members on your technical issues.">
        <meta name="keywords" content="Java, Algorithms, forum, Even Numbers, Odd or Even, Even or Odd, Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<!-- design forum page within forum-pane div -->
				<div id="forum-pane">
