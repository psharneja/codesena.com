<html>
<head>
	<title>Check Prime Number - Beginner Level Java Algorithms | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="How to check if a number is prime or not? In our demo, we are going to write a Java program that checks if the given input number is prime or not.">
        <meta name="keywords" content="Java, Algorithms, Prime Numbers, Composite Numbers, Prime or not, Program, Beginner level, Codesena">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='check-odd-or-even.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='ch		eck-armstrong-number.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to check whether the given integer is prime or not.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				This program checks whether the integer value we are passing to the
				function is prime or not and display the result on standard output.</p>
				<p>So, the first question is what are prime numbers?</p>
				<p><b>Prime Numbers :</b> These are the numbers (greater than 1) which are only divisible by 1 and itself. For example, 2, 3, 5, 7, 11, 13 etc. Any other number greater than 1 which are not a prime number is known as a <b>Composite number</b>.
				</p>
				<p>
				See the below code which implements the logic to check whether the given number is prime or not.
				</p>
<pre class="language-java line-numbers" >
<code>package com.algorithms.beginner;

/**
 * The PrimeNumber program implements an application that checks whether the
 * integer input we are passing is prime or not and display the result in
 * console.
 *
 * @author Pawan
 * @version 1.0
...
public class PrimeNumber {
	...
	// method to check whether integer is prime or not
	...
	public static void main(String[] args) {
		...
		obj.isPrimeNumber(13); // prints 13 is a prime number.
		obj.isPrimeNumber(21); // prints 21 is not a prime number.
	}
}
</code>
</pre>
...
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('prime-number', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('prime-number', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			//change page_id for other pages
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'prime-number' ";
		...
		<!-- display comment section with replies - end -->
				...
				<div id="navigation" class = "row-fluid">
					...
					<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='check-armstrong-number.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				</div>
				</div>
