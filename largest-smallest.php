<html>
<head>
	<title>Largest and the smallest number in an array | Codesena</title>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="author" content="Codesena">
		<meta name="description" content="How to find the smallest and the largest number in an array? This Java program will find the smallest and the largest number in an array and display the result.">
	...
	<div id="fb-root"></div>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="previous" class="col-md-2 col-lg-2 pull-left" onclick="location.href='longest-and-shortest.php'">Previous <i class="fa fa-chevron-left pull-left" aria-hidden="true"></i>
				</div>

				<div id="next" class="col-md-2 col-lg-2 pull-right" onclick="location.href='capitalize.php'">Next <i class="fa fa-chevron-right pull-right" aria-hidden="true"></i>
				</div>
				</div>
				<div id="middle">
				...
				<hr>
				<h3 id="title">Program to find the smallest and the largest number in an array.</h3>
				<hr>
				</div>
				<div id="program" class = "row-fluid">
				<p>
				This program will find the smallest and the largest number in an array and display the result on standard output.</p>
				<p></p>
				<p>So, the logic we have used is very simple. We have sorted the input array in ascending order using <b>Arrays.sort(int [ ] array)</b>. It's obvious that after sorting the array in ascending order, the first element of the array will be the smallest. Similarly, the last element in the array would be the largest number.
				</p>
				<p>
				See the below implementation of our logic.
				</p>
...
/**
 * The LargestAndSmallest program will find the smallest and largest number in
 * the given array and prints the result in console.
 *
 * @author Pawan
 * @version 1.0
 * @since 2017-05-03
...
public class LargestAndSmallest {
	...
	public void findLargestAndSmallest(int[] array) {
		...
		System.out.println("Largest number in array is : " + array[array.length - 1]);
	}

	public static void main(String[] args) {
		LargestAndSmallest object = new LargestAndSmallest();

		int arr[] = { 21, 7, 343, 99, 4, 501 };
		object.findLargestAndSmallest(arr);
	}
}
</code>
</pre>
...
<code>
Smallest number in array is : 4
Largest number in array is : 501
</code>
</pre>
<p>Comment your queries or give feedback :</p>
	<div id="comment-pane" class="row-fluid">
			...
			<form method="post">
				...
				<button id="submit-comment" type="submit" name="submit_comment" class="btn btn-primary pull-left">Comment <span><i class="fa fa-comments fa-fw"></i></span></button>
   				...
   				<?php
					...
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('largest-smallest', '$name', '$email', '$comment', NOW(),0)"); 
				...
				<?php
				 ...
				 if(isset($_POST["submit_reply"]))
					...
					//change page_id for other pages
					mysqli_query($conn,"INSERT INTO comment_reply_tab(page_id, user_name, email_id, comment, timings, parent_id) VALUES('largest-smallest', '$replier_name', '$replier_email', '$replier_comment', NOW(),$parent_id)"); 
		...
		<?php
			...
			//change page_id for other pages
			$sql = "SELECT comment_id, page_id, user_name, email_id, comment, timings, parent_id FROM comment_reply_tab where parent_id = 0 and page_id = 'largest-smallest' ";
